...
//        window?.rootViewController = QDrawerController(centerVC: tabBarVC!, leftDrawerVC: leftVC, maxLeftDrawerWidth: UIScreen.main.bounds.size.width - 78)
        window?.rootViewController = QDrawerController(centerVC: tabBarVC!, leftDrawerVC: leftVC, maxLeftDrawerWidth: UIScreen.main.bounds.size.width - 78, rightDrawerVC: rightVC, maxRightDrawerWidth: UIScreen.main.bounds.size.width - 78)
